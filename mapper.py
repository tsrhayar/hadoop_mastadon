    ...
    try:
        ...
        if user_id is not None:
            ...
            if followers_count != 0 :
            	...
            	user_engagment = (reblogs_count + favourites_count ) / followers_count
            	#print(f"UserEngagmentRate_{user_id}\t{user_engagment}")
            	
	
            account_creation_date = account.get('created_at' , '')[:7]
            
            if account_creation_date:
                print(f"Date_{account_creation_date}\t{user_id}")
